...
//}
    ...
    void Prefab::UpdateAllInstances()
    {
        ...
        for (auto& child : mChildren)
        {
            ...
            //{
            //    //if (componentName == "Sprite Renderer Component")
            //    //{
            ...
            //    //    std::vector<std::string> variableNames = ComponentRegistry::GetPropertyNames("Sprite Renderer Component");
