...
namespace Borealis
{
	...
	bool SceneHierarchyPanel::DrawComponents(Entity entity)
	{
		...
		if (ImGui::BeginPopup("AddComponentPopup"))
		{
			...
			isEdited = SearchBar<CylinderColliderComponent>(search_text, entity,"Cylinder Capsule Collider", search_buffer) ? true : isEdited;
		...
		isEdited = DrawComponentLayout<CylinderColliderComponent>("Cylinder Capsule Collider", entity) ? true : isEdited;
